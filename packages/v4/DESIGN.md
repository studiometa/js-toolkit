...
4. Migration phases: which pieces land as non-breaking 3.x (announcements, `$watchChildren`, provide/inject could all ship in 3.x) vs v4-only breaks (bubbling `$emit`, delegation, ChildrenManager removal).
